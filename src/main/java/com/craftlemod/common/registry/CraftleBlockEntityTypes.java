...
public class CraftleBlockEntityTypes {
    ...
    public static void registerAll() {
        ...
        FACTORY_GLASS_BLOCK_BLOCK_ENTITY = registerBlockEntity("factory_block_block_entity", (MachineBlock) CraftleBlocks.FACTORY_BLOCK);
        FACTORY_BLOCK_BLOCK_ENTITY = registerBlockEntity("factory_glass_block_block_entity", (MachineBlock) CraftleBlocks.FACTORY_GLASS_BLOCK);
    }
