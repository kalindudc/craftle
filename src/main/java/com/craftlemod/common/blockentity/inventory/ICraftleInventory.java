package com.craftlemod.common.blockentity.inventory;
...
public interface ICraftleInventory extends Inventory {
     ...
     */
    static ICraftleInventory of(DefaultedList<ItemStack> items) {
        return () -> items;
    }
     ...
     */
    static ICraftleInventory ofSize(int size) {
