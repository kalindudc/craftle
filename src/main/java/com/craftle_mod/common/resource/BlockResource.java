...
public enum BlockResource implements IBlockResource {
    COPPER("copper", 3.0f, 10.0f, 1, Material.IRON),
    TIN("tin", 3.0f, 10.0f, 1, Material.IRON),
    ALUMINIUM("aluminium", 5.0f, 15.0f, 2, Material.IRON),
    PLATINUM("platinum", 5.0f, 15.0f, 2, Material.IRON),
    URANIUM("uranium", 7.5f, 22.0f, 3, Material.IRON),
    RUBY("ruby", 5.0f, 15.0f, 2, Material.IRON),
    SAPPHIRE("sapphire", 5.0f, 15.0f, 2, Material.IRON),
