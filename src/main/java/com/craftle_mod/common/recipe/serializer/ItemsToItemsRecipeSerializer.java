...
public class ItemsToItemsRecipeSerializer<T extends ItemsToItemsRecipe> extends
    ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<T> {
    ...
    public T read(@Nonnull ResourceLocation recipeId, @Nonnull JsonObject json) {
        JsonElement input = JSONUtils.isJsonArray(json, JsonConstants.INPUT) ? JSONUtils
            .getJsonArray(json, JsonConstants.INPUT)
        ...
        ItemStack output = SerializationHelper.getItemStack(json, JsonConstants.OUTPUT);
        if (output.isEmpty()) {
    ...
    public interface IRFactory<T extends ItemsToItemsRecipe> {
        ...
        T create(ResourceLocation id, ItemStackIngredient ingredient, ItemStack output);
    }
}
