...
public class CraftleBiomes {
    ...
    public static final DeferredRegister<Biome> BIOMES = new DeferredRegister<>(
        ForgeRegistries.BIOMES, Craftle.MODID);
    ...
    public static void registerBiomes() {
        registerBiome(TEST_BIOME.get(), BiomeDictionary.Type.PLAINS, BiomeDictionary.Type.OVERWORLD,
