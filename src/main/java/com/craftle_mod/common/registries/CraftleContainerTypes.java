...
public class CraftleContainerTypes {
    ...
    public static final RegistryObject<ContainerType<CrusherContainer>> CRUSHER_BASIC = CONTAINER_TYPES
        .register("crusher_basic", () -> IForgeContainerType
            .create(CrusherContainerFactory.buildContainerFactory(CraftleBaseTier.BASIC)));
    public static final RegistryObject<ContainerType<CrusherContainer>> CRUSHER_TIER_1 = CONTAINER_TYPES
        .register("crusher_tier_1", () -> IForgeContainerType
            .create(CrusherContainerFactory.buildContainerFactory(CraftleBaseTier.TIER_1)));
    public static final RegistryObject<ContainerType<CrusherContainer>> CRUSHER_TIER_2 = CONTAINER_TYPES
        .register("crusher_tier_2", () -> IForgeContainerType
            .create(CrusherContainerFactory.buildContainerFactory(CraftleBaseTier.TIER_2)));
    public static final RegistryObject<ContainerType<CrusherContainer>> CRUSHER_TIER_3 = CONTAINER_TYPES
        .register("crusher_tier_3", () -> IForgeContainerType
            .create(CrusherContainerFactory.buildContainerFactory(CraftleBaseTier.TIER_3)));
    public static final RegistryObject<ContainerType<CrusherContainer>> CRUSHER_TIER_4 = CONTAINER_TYPES
        .register("crusher_tier_4", () -> IForgeContainerType
    ...
    public static final RegistryObject<ContainerType<EnergyMatrixContainer>> ENERGY_MATRIX_BASIC = registerEnergyMatrix(
        CraftleBaseTier.BASIC);
    public static final RegistryObject<ContainerType<EnergyMatrixContainer>> ENERGY_MATRIX_TIER_1 = registerEnergyMatrix(
        CraftleBaseTier.TIER_1);
    public static final RegistryObject<ContainerType<EnergyMatrixContainer>> ENERGY_MATRIX_TIER_2 = registerEnergyMatrix(
        CraftleBaseTier.TIER_2);
    public static final RegistryObject<ContainerType<EnergyMatrixContainer>> ENERGY_MATRIX_TIER_3 = registerEnergyMatrix(
        CraftleBaseTier.TIER_3);
    public static final RegistryObject<ContainerType<EnergyMatrixContainer>> ENERGY_MATRIX_TIER_4 = registerEnergyMatrix(
