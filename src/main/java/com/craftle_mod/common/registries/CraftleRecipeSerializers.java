...
public class CraftleRecipeSerializers {
    ...
    public static final RecipeSerializerDeferredRegister SERIALIZERS = new RecipeSerializerDeferredRegister(
        Craftle.MODID);

    public static final RecipeSerializerRegistryObject<CrushingRecipe> CRUSHING = SERIALIZERS
        .register("crushing", () -> new ItemsToItemsRecipeSerializer<>(CrushingRecipe::new));
}
