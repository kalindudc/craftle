...
public class EnergyMatrix extends MachineBlock {
    ...
    private static final VoxelShape SHAPE_N = Stream
        .of(Block.makeCuboidShape(1, 1, 1, 15, 15, 15), Block.makeCuboidShape(5, 5, 0, 11, 16, 1),
            Block.makeCuboidShape(5, 15, 1, 11, 16, 11), Block.makeCuboidShape(0, 0, 5, 11, 1, 11),
            ...
            Block.makeCuboidShape(15, 3, 0, 16, 16, 4), Block.makeCuboidShape(12, 3, 0, 15, 16, 1),
            Block.makeCuboidShape(12, 15, 1, 15, 16, 4), Block.makeCuboidShape(3, 0, 15, 16, 4, 16),
            Block.makeCuboidShape(3, 0, 12, 16, 1, 15), Block.makeCuboidShape(15, 1, 12, 16, 4, 15),
            Block.makeCuboidShape(0, 15, 12, 13, 16, 15),
            Block.makeCuboidShape(0, 12, 15, 13, 16, 16),
            Block.makeCuboidShape(0, 12, 12, 1, 15, 15), Block.makeCuboidShape(0, 0, 0, 1, 13, 4),
            Block.makeCuboidShape(1, 0, 0, 4, 13, 1), Block.makeCuboidShape(1, 0, 1, 4, 1, 4))
        .reduce((v1, v2) -> VoxelShapes.combineAndSimplify(v1, v2, IBooleanFunction.OR)).get();

    private static final VoxelShape SHAPE_E = Stream
        .of(Block.makeCuboidShape(1, 1, 1, 15, 15, 15), Block.makeCuboidShape(15, 5, 5, 16, 16, 11),
            Block.makeCuboidShape(5, 15, 5, 15, 16, 11), Block.makeCuboidShape(5, 0, 0, 11, 1, 11),
            ...
            Block.makeCuboidShape(12, 15, 12, 15, 16, 15), Block.makeCuboidShape(0, 0, 3, 1, 4, 16),
            Block.makeCuboidShape(1, 0, 3, 4, 1, 16), Block.makeCuboidShape(1, 1, 15, 4, 4, 16),
            Block.makeCuboidShape(1, 15, 0, 4, 16, 13), Block.makeCuboidShape(0, 12, 0, 1, 16, 13),
            Block.makeCuboidShape(1, 12, 0, 4, 15, 1), Block.makeCuboidShape(12, 0, 0, 16, 13, 1),
            Block.makeCuboidShape(15, 0, 1, 16, 13, 4), Block.makeCuboidShape(12, 0, 1, 15, 1, 4))
        .reduce((v1, v2) -> VoxelShapes.combineAndSimplify(v1, v2, IBooleanFunction.OR)).get();

    private static final VoxelShape SHAPE_S = Stream
        .of(Block.makeCuboidShape(1, 1, 1, 15, 15, 15), Block.makeCuboidShape(5, 5, 15, 11, 16, 16),
            Block.makeCuboidShape(5, 15, 5, 11, 16, 15), Block.makeCuboidShape(5, 0, 5, 16, 1, 11),
            ...
            Block.makeCuboidShape(0, 3, 12, 1, 16, 16), Block.makeCuboidShape(1, 3, 15, 4, 16, 16),
            Block.makeCuboidShape(1, 15, 12, 4, 16, 15), Block.makeCuboidShape(0, 0, 0, 13, 4, 1),
            Block.makeCuboidShape(0, 0, 1, 13, 1, 4), Block.makeCuboidShape(0, 1, 1, 1, 4, 4),
            Block.makeCuboidShape(3, 15, 1, 16, 16, 4), Block.makeCuboidShape(3, 12, 0, 16, 16, 1),
    ...
    private static final VoxelShape SHAPE_W = Stream
        .of(Block.makeCuboidShape(1, 1, 1, 15, 15, 15), Block.makeCuboidShape(0, 5, 5, 1, 16, 11),
            Block.makeCuboidShape(1, 15, 5, 11, 16, 11), Block.makeCuboidShape(5, 0, 5, 11, 1, 16),
            ...
            Block.makeCuboidShape(0, 3, 0, 4, 16, 1), Block.makeCuboidShape(0, 3, 1, 1, 16, 4),
            Block.makeCuboidShape(1, 15, 1, 4, 16, 4), Block.makeCuboidShape(15, 0, 0, 16, 4, 13),
            Block.makeCuboidShape(12, 0, 0, 15, 1, 13), Block.makeCuboidShape(12, 1, 0, 15, 4, 1),
            Block.makeCuboidShape(12, 15, 3, 15, 16, 16),
            Block.makeCuboidShape(15, 12, 3, 16, 16, 16),
            Block.makeCuboidShape(12, 12, 15, 15, 15, 16),
            Block.makeCuboidShape(0, 0, 15, 4, 13, 16), Block.makeCuboidShape(0, 0, 12, 1, 13, 15),
    ...
    public ContainerType<?> getContainerType() {
        switch (getCraftleTier()) {
            case UNLIMITED:
            case TIER_4:
                return CraftleContainerTypes.ENERGY_MATRIX_TIER_4.get();
            case TIER_3:
                return CraftleContainerTypes.ENERGY_MATRIX_TIER_3.get();
            case TIER_2:
                return CraftleContainerTypes.ENERGY_MATRIX_TIER_2.get();
            case TIER_1:
                return CraftleContainerTypes.ENERGY_MATRIX_TIER_1.get();
            case BASIC:
            default:
                return CraftleContainerTypes.ENERGY_MATRIX_BASIC.get();
        }
    }
}
